...
.directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: 'scripts/vendor/angular-ui/template/accordion/accordion.html'
  };
})
...
.directive('accordionGroup', ['$parse', '$transition', '$timeout', function($parse, $transition, $timeout) {
  return {
    ...
    templateUrl: 'scripts/vendor/angular-ui/template/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", []).directive('alert', function () {
  return {
    restrict:'EA',
    templateUrl: 'scripts/vendor/angular-ui/template/alert/alert.html',
    transclude:true,
    replace:true,
    scope: {
      type: '=',
...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: 'scripts/vendor/angular-ui/template/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '=',
      noPause: '='
...
.directive('slide', ['$parse', function($parse) {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: 'scripts/vendor/angular-ui/template/carousel/slide.html',
    scope: {
    },
...
.directive( 'datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: 'scripts/vendor/angular-ui/template/datepicker/datepicker.html',
    scope: {
      dateDisabled: '&'
    },
...
.directive('datepickerPopupWrap', [function() {
  return {
    ...
    replace: true,
    transclude: true,
    templateUrl: 'scripts/vendor/angular-ui/template/datepicker/popup.html',
    link:function (scope, element, attrs) {
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: 'scripts/vendor/angular-ui/template/dialog/message.html', controller: 'MessageBoxController', resolve:
          {model: function() {
            return {
              title: title,
              message: message,
...
.directive('pagination', ['paginationConfig', function(config) {
  return {
    ...
    templateUrl: 'scripts/vendor/angular-ui/template/pagination/pagination.html',
    replace: true,
...
.directive('pager', ['pagerConfig', function(config) {
  return {
    ...
    controller: 'PaginationController',
    templateUrl: 'scripts/vendor/angular-ui/template/pagination/pager.html',
    replace: true,
    link: function(scope, element, attrs, paginationCtrl) {
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: 'scripts/vendor/angular-ui/template/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: 'scripts/vendor/angular-ui/template/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: 'scripts/vendor/angular-ui/template/popover/popover.html'
  };
})
...
.directive('progress', function() {
    return {
        ...
        templateUrl: 'scripts/vendor/angular-ui/template/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function($transition) {
    return {
        ...
        templateUrl: 'scripts/vendor/angular-ui/template/progressbar/bar.html',
...
.directive('rating', ['ratingConfig', '$parse', function(ratingConfig, $parse) {
  return {
    ...
    templateUrl: 'scripts/vendor/angular-ui/template/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs) {
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: 'scripts/vendor/angular-ui/template/tabs/tabset.html',
...
function($parse, $http, $templateCache, $compile) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: 'scripts/vendor/angular-ui/template/tabs/tab.html',
    transclude: true,
    scope: {
      heading: '@',
...
.directive('tabsetTitles', function($http) {
  return {
    restrict: 'A',
    require: '^tabset',
    templateUrl: 'scripts/vendor/angular-ui/template/tabs/tabset-titles.html',
    replace: true,
...
.directive('timepicker', ['padFilter', '$parse', 'timepickerConfig', function (padFilter, $parse, timepickerConfig) {
  return {
    ...
    require:'ngModel',
    replace: true,
    templateUrl: 'scripts/vendor/angular-ui/template/timepicker/timepicker.html',
    scope: {
        model: '=ngModel'
    },
    link: function(scope, element, attrs, ngModelCtrl) {
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl: 'scripts/vendor/angular-ui/template/typeahead/typeahead-popup.html',
      link:function (scope, element, attrs) {
